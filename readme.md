...
- [Position-Based Quantum Cryptography](https://github.com/Renaller/awesome-position-based-quantum-cryptography#readme) - Quantum Cryptography that utilizes special relativistic constraints to achieve security under certain conditions.
